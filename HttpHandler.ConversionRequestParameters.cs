...
namespace CadViewer.HttpHandler
{
	...
	/// </summary>
	public sealed class ConversionRequestParameters
	{
		...
		public static ConversionRequestParameters FromJSON(string json) => Util.FromJSON<ConversionRequestParameters>(json);
		public static ConversionRequestParameters FromJSON(System.IO.TextReader Reader) => Util.FromJSON<ConversionRequestParameters>(Reader);
	}
}
